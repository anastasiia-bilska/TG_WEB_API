  ...
  <main class="container">
    <section class="haptic">
      <div class="haptic__impact">
        ...
        <article class="mb-4">
          <p>
            <i><strong>notificationOccurred(type)</strong></i> - a method tells that a task or
            action has succeeded, failed, or produced a warning. The Telegram app may play the
            appropriate haptics based on type value passed. Type can be one of these values:
          </p>
